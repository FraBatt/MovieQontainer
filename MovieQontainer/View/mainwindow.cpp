...
MainWindow::MainWindow(QWidget *parent) : QWidget(parent) {
    ...
    contGrid->setColumnMinimumWidth(0,400);
    contGrid->setColumnMinimumWidth(1,400);

    contGrid->setRowMinimumHeight(0, 200);
    contGrid->setRowMinimumHeight(1, 200);
    contGrid->setRowMinimumHeight(2, 200);
    ...
    titleLabel->setFixedSize(400, 200);
...
void MainWindow::viewResultSearch(vector<movieitem*> resultVector) {
    ...
    B->addButton(tr("Elimina"), QDialogButtonBox::AcceptRole);
